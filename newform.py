...
with open('links.txt','r') as fo:
 ...
 ##################################😎 HOME TEAM CONFIG ###################################################
      ...
      #search_teams_history = driver.find_element_by_css_selector('div.matchbtwteams div.matches > div.matchitem:nth-of-type(2) a, div.matchbtwteams div.matches > div.matchitem:nth-of-type(2) div.match div.goals')
      ...
      #teams_history = search_teams_history.text

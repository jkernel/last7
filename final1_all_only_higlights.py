...
with open('links.txt','r') as fo:
 ...
 ##################################😎 HOME TEAM CONFIG ###################################################
      ...
      driver.quit()
      if 'L' in team1_7th:
      	print("-->Γηπεδούχοι {}--> ΉΤΤΑ στο 7ο!".format(team1_name))
      	
      if 'L' in team2_7th:
      	print("-->Φιλοξενούμενοι {}--> ΉΤΤΑ στο 7ο!".format(team2_name))
      try:
      	print("Προϊστορία: Οι γηπεδούχοι {} μετρούν συνολικά {} νίκες ενώ οι φιλοξενούμενοι {} {}. Οι ισοπαλίες ήταν {}.".format(team1_name,history_team1_wins,team2_name,history_team2_wins,history_draws))
      except NameError:
